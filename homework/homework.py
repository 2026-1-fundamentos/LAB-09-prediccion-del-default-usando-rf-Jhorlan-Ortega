...
def main():
    ...
    test_df = load_dataset(os.path.join(input_path_file, "test_data.csv.zip"))
    train_df = load_dataset(os.path.join(input_path_file, "train_data.csv.zip"))
    ...
    with open(os.path.join(output_path_file, "metrics.json"), "w") as file:
